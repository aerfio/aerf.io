  ...
  return (
    <>
      <section className="grid self-end p-4 grid-in-nickname">
        ...
        >
          <span className="translate-none absolute top-[2px] left-[2px] h-6 w-6 rounded-full border-0 border-solid border-primarylight bg-white transition-all duration-300 ease-in content-[''] dark:left-[calc(100%-2px)] dark:translate-x-[-100%] dark:border-primarydark">
            {isDarkThemeEnabled ? (
              <FiSun {...iconProps} />
            ) : (
              <FiMoon {...iconProps} />
